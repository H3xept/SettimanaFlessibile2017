...
<div align="center">
	<h2><b>Files utili:</b></h2>
	<h3><a href="{{url('/files/Correzioni.pdf')}}">Correzioni</a></h3>
	<h3><a href="{{url('/files/Info.pdf')}}">Info - Regole</a></h3>
</div>
...
<?php $users = DB::table('users')->select(array('id','name','class','surname'))->get();?>
