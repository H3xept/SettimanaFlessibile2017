...
<div id="list-id" class="jumbotron" align="center" style=" border-color: #CCCCCC;border-width: 1px;border-style:solid;">
  ...
  <tboy>
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f1']}}</a><button id="f1Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f1'][0]}}/{{$courses_id_array['f1'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f2']}}</a><button id="f2Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f2'][0]}}/{{$courses_id_array['f2'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f3']}}</a><button id="f3Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f3'][0]}}/{{$courses_id_array['f3'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f4']}}</a><button class="btn btn-danger pull-right" id="f4Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" href="/courses/{{$courses_id_array['f4'][0]}}/{{$courses_id_array['f4'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f5']}}</a><button id="f5Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f5'][0]}}/{{$courses_id_array['f5'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f6']}}</a><button id="f6Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f6'][0]}}/{{$courses_id_array['f6'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f7']}}</a><button id="f7Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f7'][0]}}/{{$courses_id_array['f7'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f8']}}</a><button id="f8Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f8'][0]}}/{{$courses_id_array['f8'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
...
<script type="text/javascript">
    ...
    <tr>
        ...
        <td><a href="#">{{$courses_name_array['f9']}}</a><button id="f9Button" data-loading-text="<i class='fa fa-spinner fa-spin'>" class="btn btn-danger pull-right" href="/courses/{{$courses_id_array['f9'][0]}}/{{$courses_id_array['f9'][1]}}/unsign/{{$user_id}}"><i class="fa fa-trash"></i></button></td>
