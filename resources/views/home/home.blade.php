...
<div id="list-id" class="jumbotron" align="center" style=" border-color: #CCCCCC;border-width: 1px;border-style:solid;">
    ...
    <h4><a href="{{url('/files/DisposizioneClassi.pdf')}}"><b>DISPOSIZIONE CLASSI - IN CHE CLASSE E' IL MIO CORSO?</b></a></h4><br>
    <h4><a href="{{url('/files/UbicazioneClassi.pdf')}}"><b>UBICAZIONE CLASSI - DOVE STA QUESTA CLASSE?</b></a></h4><br>
    <h4><a href="{{url('/files/Correzioni.pdf')}}"><b>CORREZIONI - HO UNA FASCIA VUOTA, DOVE DEVO ANDARE?</b></a><br><small>(Cercare nel file la propria classe.)</small></h4>
